...
export const CHART_REGISTRY_SERVICE = Symbol('CHART_REGISTRY_SERVICE');
export const MULTI_TIMEFRAME_CHART_SERVICE = Symbol('MULTI_TIMEFRAME_CHART_SERVICE');
...
export const MULTI_TIMEFRAME_ANALYSIS_SERVICE = Symbol('MULTI_TIMEFRAME_ANALYSIS_SERVICE');
